...
public:
	 ...
	 */
	void eliminarHerramienta(int fila, int columna, int altura);
	/*
	 ...
	 */
	void eliminarSoldado(int fila, int columna, int altura);
	/*
	 ...
	 */
	bool buscarSoldado(int fila, int columna, int altura);
	/*
	 *Pre: recibe posicion de fila y columna
	 *Post: si encuentra un id coincidente con las coordenadas devuelve unsigned int
	 */
	unsigned int buscarIdSoldado(int fila, int columna, int altura);

	/*
	 *Pre: recibe posicion de fila y columna
	 *Post: devuelve si encuentra una herramienta en las coordenadas
	 */
	bool buscarHerramienta(int fila, int columna, int altura);

	/*
	 *Pre: recibe posicion de fila y columna
	 *Post: devuelve el numero si coincide la herramienta con las coordenadas
	 */
	int buscarIdHerramienta(int fila, int columna, int altura);
};
