...
public:
	 ...
	 */
	BatallaCampal(unsigned int cantidadJugadores, unsigned int cantidadSoldados,
			int dimensionTablero);
	/*
	 ...
	 */
	Ficha* moverFicha(char movimiento, int x, int y, int z, Jugador* jugador);
	/*
	 ...
	 */
	bool soldadosCoinciden(int x, int y, int z);
	/*
	 * Pre: Necesita las coordenadas de la fila y la columna
	 ...
	 */
	void usarCarta(Jugador* jugador, int numero, int x, int y, int z,
			char filaOColumna);
	/*
	 * Pre: Necesita las coordenadas de la casilla
	 ...
	 */
	bool eliminarEnemigo(int x, int y, int z);
	/*
	 * Pre:
