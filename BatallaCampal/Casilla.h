...
enum EstadoDelCasillero {
	VACIO, INACTIVO, LLENO, MINADO
};

enum TipoDeCasillero {
	AIRE, TIERRA, AGUA, GENERAL
};
...
public:
	 ...
	 */
	Casilla(unsigned int coordenadaX, unsigned int coordenadaY,
			unsigned int coordenadaZ, TipoDeCasillero tipo);
	 ...
	 */
	void setCoordenada(unsigned int &coordenadaAModificar,
